...
const FeaturedWork = () => {
  ...
  return (
    <Box py={{ base: 12, md: 20 }} bg="brand.cardBg" mx={{ base: -4, md: -8, lg: -16 }} px={{ base: 4, md: 8, lg: 16 }}>
      ...
      >
        <Box>
          <Text className="font-subtitle" fontFamily="'Outfit', sans-serif" fontSize="sm" letterSpacing="0.08em" color="brand.muted" fontWeight="600" mb={2}>
            {t("home.selected.kicker")}
          </Text>
          <Heading as="h2" fontFamily="'Outfit', sans-serif" fontSize={{ base: "4xl", md: "5xl" }} fontWeight="500" color="brand.ink">
