...
export const COLORS = {
  ...
  BORDER: "rgba(212, 137, 74, 0.28)",
  NEON: "#d4894a",
  NEON_GLOW: "0 0 18px rgba(224, 92, 40, 0.28)",
  NEON_GLOW_STRONG: "0 0 28px rgba(224, 92, 40, 0.4)",
  NEON_GLOW_WEAK: "0 0 12px rgba(224, 92, 40, 0.18)",
  BACKGROUND: "#0e0c0a",
